<template>
  <view class="home-container">
    ...
    <view class="welcome-row">
      ...
      <image class="avatar" src="https://placehold.co/60x60/EFEFEF/AAAAAA&text=头像" style="width:48px;height:48px;border-radius:50%;border:2px solid #fff;box-shadow:0 2px 8px rgba(0,0,0,0.06);" />
    </view>
...
.featured-card {
  ...
  background-image: url(/static/icons/maskGroup.png) center no-repeat;
  border-radius: 20px;
  margin-right: 16px;
